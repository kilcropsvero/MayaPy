...
def L_arm(*args):
    ...
    # (END OF THE RIGHT ARM)
        ...
        mc.addAttr(ikcc, ln='StrechyUpAmount', attributeType='long', dv=1, k=True, h=False)
        mc.addAttr(ikcc, ln='StrechyLoAmount', attributeType='long', dv=1, k=True, h=False)
        ...
        mc.connectAttr('L_upTwist_01_JC.rx', 'L_uparmTwist_MULT.input1Y')
        mc.connectAttr('L_upTwist_01_JC.rx', 'L_uparmTwist_MULT.input1Z')
        ...
        mc.connectAttr('L_loTwist_01_JC.rx', 'L_loarmTwist_MULT.input1Y')
        mc.connectAttr('L_loTwist_01_JC.rx', 'L_loarmTwist_MULT.input1Z')
        ...
        # Add Stretchy On/Off
        onOff= mc.shadingNode('multiplyDivide', asUtility=True, name='L_armStretchyOnOff_MULT')
        #
        ...
        if mc.radioButton('ikfkex', query=True, select=True):
            ...
            mc.connectAttr('L_arm_REV.outputX', '{}.v'.format(LarmAnnot))
            #
        ...
        if mc.radioButton('rarm', query=True, select=True):
            ...
            def R_arm():
                ...
                mc.connectAttr('R_upTwist_01_JC.rx', 'R_uparmTwist_MULT.input1Y')
                mc.connectAttr('R_upTwist_01_JC.rx', 'R_uparmTwist_MULT.input1Z')
                ...
                mc.connectAttr('R_loTwist_01_JC.rx', 'R_loarmTwist_MULT.input1Y')
                mc.connectAttr('R_loTwist_01_JC.rx', 'R_loarmTwist_MULT.input1Z')
                ...
                # Add Stretchy On/Off
                onOff = mc.shadingNode('multiplyDivide', asUtility=True, name='R_armStretchyOnOff_MULT')
                ...
                if mc.radioButton('ikfkex', query=True, select=True):
                    ...
                    mc.connectAttr('R_arm_REV.outputX', '{}.v'.format(RarmAnnot))
                    #
